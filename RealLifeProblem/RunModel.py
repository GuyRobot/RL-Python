...
if __name__ == '__main__':
    ...
    prices = DataHandler.load_relative(args.data)
    env = Enviroment.StocksEnv({"TEST": prices}, bars_count=args.bars,
                               reset_on_close=False, commission=args.commission,
                               state_1d=args.conv, random_ofs_on_reset=False,
